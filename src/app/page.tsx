...
const challenges: Challenge[] = [
  ...
  return str.___BLANK_1___(find, replace);
		...
		testCases: [
			{ input: ["hello hello", "hello", "hi"], expected: "hi hello", description: "Replace first hello" },
  ...
  return sentences.___BLANK_1___(s => s.split(" "));
		...
		testCases: [
			{ input: [["hello world", "hi there"]], expected: ["hello", "world", "hi", "there"], description: "Split sentences" },
  ...
  return Promise.___BLANK_1___(promises);
		...
		testCases: [{ input: [[Promise.resolve(1), Promise.resolve(2)]], expected: 1, description: "First resolved" }],
		points: 230,
	},
	{
		id: 41,
  ...
  return items.___BLANK_1___((a, b) => a.name.localeCompare(b.name));
		...
		blanks: [{ id: "BLANK_1", answer: "sort", placeholder: "sort" }],
		testCases: [{ input: [[{ name: "b" }, { name: "a" }]], expected: [{ name: "a" }, { name: "b" }], description: "Sort by name" }],
		points: 240,
	},
	{
		id: 43,
  ...
  return Promise.___BLANK_1___(promises);
		...
		testCases: [{ input: [[Promise.resolve(1)]], expected: [{ status: "fulfilled", value: 1 }], description: "All results" }],
		points: 240,
	},
	{
		id: 44,
  ...
  return new URL(url).___BLANK_1___;
		...
		testCases: [{ input: ["https://example.com?a=1"], expected: new URLSearchParams("a=1"), description: "Get params" }],
		points: 270,
	},
	{
		id: 49,
  ...
  return new ___BLANK_1___(arr);
		...
		testCases: [{ input: [[1, 1, 2, 2]], expected: new Set([1, 2]), description: "Unique [1,1,2,2]" }],
		points: 270,
	},
	{
		id: 50,
  ...
  return new Map(Object.___BLANK_1___(obj));
		...
		blanks: [{ id: "BLANK_1", answer: "entries", placeholder: "entries" }],
		testCases: [{ input: [{ a: 1 }], expected: new Map([["a", 1]]), description: "Map from {a:1}" }],
		points: 280,
	},
	{
		id: 51,
  ...
  return Object.groupBy(arr, item => item.___BLANK_1___);
		...
		blanks: [{ id: "BLANK_1", answer: "length", placeholder: "length" }],
		testCases: [{ input: [["a", "bb"]], expected: { "1": ["a"], "2": ["bb"] }, description: "Group by length" }],
		points: 300,
	},
	{
		id: 55,
						...
						<div className="flex items-center justify-center gap-2">
							...
							<Button
								...
								onClick={() => {
									...
									if (ctx) {
										// Set background
										ctx.fillStyle = document.documentElement.classList.contains("dark") ? "#020817" : "#ffffff";
										...
										ctx.fillText(`Coding IQ: ${Math.min(200, Math.round((score / 700) * 150 + (accuracy / 100) * 50))}`, 600, 260);
					...
					<Card className="p-8 border border-border bg-card">
						...
						<div className="space-y-4 mb-8">
							...
							<div className="text-sm text-muted-foreground text-left space-y-2">
								<p>• Speed Rating: {wpm < 5 ? "Beginner" : wpm < 10 ? "Intermediate" : wpm < 15 ? "Advanced" : "Expert"}</p>
								<p>• Accuracy Rating: {accuracy < 60 ? "Needs Practice" : accuracy < 80 ? "Good" : accuracy < 90 ? "Great" : "Excellent"}</p>
								<p>• Challenge Level: {solved < 5 ? "Beginner" : solved < 10 ? "Intermediate" : solved < 15 ? "Advanced" : "Master"}</p>
							</div>
						</div>
							...
							{feedback && (
								<motion.div
									className={`p-3 rounded-md text-sm border ${
										feedback.type === "success" ? "bg-green-950 text-green-400 border-green-800" : "bg-red-950 text-red-400 border-red-800"
									}`}
